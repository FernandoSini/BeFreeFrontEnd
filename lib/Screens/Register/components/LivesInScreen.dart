...
class LivesInScreen extends StatelessWidget {
  TextEditingController livesInController = TextEditingController(text: "");
              ...
              child: Consumer<RegisterProvider>(
                builder: (_, registerProvider, __) => TextFormField(
                  decoration: InputDecoration(
                    ...
                    labelText: "Example: São Paulo, Brazil, New York, United States",
                  ...
                  onChanged: (value) {
                    registerProvider.setLivesIn(value);
                  },
                ),
              ),
            ),
