...
import 'package:be_free_front/Models/Message.dart';
import 'package:be_free_front/Models/User.dart';
import 'package:be_free_front/Providers/MessagesProvider.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  String socketUrl = "ws://192.168.0.136:8080/socket";
  ...
  void onSend(String text) {
    ...
    stompClient!.send(
      ...
      // body: jsonEncode(message.toJson()).toString()
      // body: jsonEncode(message.toJson()).toString());
      body: jsonEncode(message.toJson()).toString(),
  ...
  void initState() {
    ...
    stompClient = StompClient(
      config: StompConfig(
        ...
        onUnhandledFrame: (frame) => print(frame.body),
        onDisconnect: (frame) =>
        ...
        onUnhandledMessage: (data) => print(data.body.toString()),
...
//   TextEditingController controllerMessage = TextEditingController(text: "");
//   ScrollController _scrollController = ScrollController();
//   String socketUrl = "http://192.168.0.136:8080/socket";
//   void onConnect(StompFrame frame) {
//     if (stompClient != null) {
//       stompClient!.subscribe(
//         headers: {
