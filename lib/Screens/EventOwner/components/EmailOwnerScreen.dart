...
import 'package:be_free_front/Screens/Register/components/PasswordScreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:provider/provider.dart';

class EmailOwnerScreen extends StatelessWidget {
  TextEditingController emailControllerOwner = TextEditingController(text: "");
            ...
            Container(
              ...
              child: Consumer<RegisterEventOwnerProvider>(
                builder: (_, registerEventOwner, __) => TextFormField(
                  ...
                  controller: emailControllerOwner,
                  onChanged: (value) {
                    registerEventOwner.setEmail(value);
                  },
                ),
              ),
            ),
