...
import 'package:be_free_v1/Providers/EventOwnerAvatarProvider.dart';
  ...
  void onImageSelected(io.File image) async {
    ...
    if (widget.owner?.avatarProfile == null) {
      await Provider.of<EventOwnerAvatarProvider>(context, listen: false)
          .uploadAvatar(
              widget.owner!.eventOwnerId!, image, widget.owner!.token);
      if (Provider.of<EventOwnerAvatarProvider>(context, listen: false)
          .isUploaded) {
